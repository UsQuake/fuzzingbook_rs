...
build_time_vars = {
    ...
    'ALIGNOF_SIZE_T': 4,
    'ALT_SOABI': '"cpython-313-wasm32-wasi"',
    'ANDROID_API_LEVEL': 0,
    'AR': '/opt/experiment/wasi-sdk-22.0/bin/llvm-ar',
    'ARFLAGS': 'rcs',
    ...
    'BYTESTR_DEPS': '\\',
    'CC': '/opt/experiment/wasi-sdk-22.0/bin/clang --sysroot=/opt/experiment/wasi-sdk-22.0/share/wasi-sysroot',
    'CCSHARED': '',
    ...
    'CONFIG_ARGS': "'--host=wasm32-wasi' '--build=x86_64-pc-linux-gnu' '--with-build-python=/opt/experiment/cpython/cross-build/build/python' '--config-cache' '--with-pydebug' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=wasm32-wasi' 'PKG_CONFIG_PATH=' 'PKG_CONFIG_LIBDIR=/opt/experiment/wasi-sdk-22.0/share/wasi-sysroot/lib/pkgconfig:/opt/experiment/wasi-sdk-22.0/share/wasi-sysroot/share/pkgconfig' 'CC=/opt/experiment/wasi-sdk-22.0/bin/clang --sysroot=/opt/experiment/wasi-sdk-22.0/share/wasi-sysroot' 'CPP=/opt/experiment/wasi-sdk-22.0/bin/clang-cpp --sysroot=/opt/experiment/wasi-sdk-22.0/share/wasi-sysroot' 'HOSTRUNNER=/root/.wasmtime/bin/wasmtime run --wasm max-wasm-stack=8388608 --wasi preview2 --dir /opt/experiment/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13-pydebug'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.13d',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/opt/experiment/cpython/cross-build/wasm32-wasi/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/opt/experiment/cpython/cross-build/wasm32-wasi/lcov-report',
    ...
    'CXX': '/opt/experiment/wasi-sdk-22.0/bin/clang++ --sysroot=/opt/experiment/wasi-sdk-22.0/share/wasi-sysroot',
    ...
    'EXE': '.wasm',
    'EXEMODE': 755,
    'EXENAME': '/usr/local/bin/python3.13d.wasm',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    'EXT_SUFFIX': '.cpython-313d-wasm32-wasi.so',
    'FILEMODE': 644,
    'FLOAT_WORDS_BIGENDIAN': 0,
    'FREEZE_MODULE': '/opt/experiment/cpython/cross-build/build/python ../../Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/opt/experiment/cpython/cross-build/build/python ../../Programs/_freeze_module.py',
    ...
    'HAVE__GETPTY': 0,
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': '/root/.wasmtime/bin/wasmtime run --wasm max-wasm-stack=8388608 --wasi preview2 --dir /opt/experiment/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13-pydebug',
    'HOST_GNU_TYPE': 'wasm32-unknown-wasi',
    'INCLDIRSTOMAKE': '/usr/local/include /usr/local/include /usr/local/include/python3.13d /usr/local/include/python3.13d',
    'INCLUDEDIR': '/usr/local/include',
    'INCLUDEPY': '/usr/local/include/python3.13d',
    ...
    'LIBEXPAT_CFLAGS': '-I../../Modules/expat -fno-strict-overflow -Wsign-compare -g -Og -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I../../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -g -Og -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I../../Modules/_decimal/libmpdec -DTEST_COVERAGE -DCONFIG_32=1 -DANSI=1 -fno-strict-overflow -Wsign-compare -g -Og -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': 'Python/dup2$U.o',
    'LIBPC': '/usr/local/lib/pkgconfig',
    'LIBPL': '/usr/local/lib/python3.13/config-3.13d-wasm32-wasi',
    'LIBRARY': 'libpython3.13d.a',
    'LIBRARY_DEPS': 'libpython3.13d.a',
    'LIBRARY_OBJS': '\\',
    'LIBRARY_OBJS_OMIT_FROZEN': '\\',
    'LIBS': '-ldl  -lwasi-emulated-signal -lwasi-emulated-getpid -lwasi-emulated-process-clocks',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/opt/experiment/wasi-sdk-22.0/bin/clang --sysroot=/opt/experiment/wasi-sdk-22.0/share/wasi-sysroot',
    'LINKFORSHARED': '',
    'LINK_PYTHON_DEPS': 'libpython3.13d.a',
    'LINK_PYTHON_OBJS': '\\',
    'LIPO_32BIT_FLAGS': '',
    'LIPO_INTEL64_FLAGS': '',
    'LLVM_PROF_ERR': 'no',
    ...
    'MODULE__DECIMAL_CFLAGS': '-I../../Modules/_decimal/libmpdec -DTEST_COVERAGE -DCONFIG_32=1 -DANSI=1',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='/root/.wasmtime/bin/wasmtime run --wasm max-wasm-stack=8388608 --wasi preview2 --dir /opt/experiment/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13-pydebug' _PYTHON_PROJECT_BASE=/opt/experiment/cpython/cross-build/wasm32-wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /opt/experiment/cpython/cross-build/wasm32-wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata_d_wasi_wasm32-wasi /opt/experiment/cpython/cross-build/build/python",
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/opt/experiment/cpython/cross-build/build/python',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha2,sha3,blake2"',
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -g -Og -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -DPy_BUILD_CORE_BUILTIN',
    ...
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -g -Og -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'PY_SUPPORT_TIER': 2,
    'Py_DEBUG': 1,
    'Py_ENABLE_SHARED': 0,
    'Py_GIL_DISABLED': 0,
    ...
    'SIZEOF_WCHAR_T': 4,
    'SIZEOF__BOOL': 1,
    'SOABI': 'cpython-313d-wasm32-wasi',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='/root/.wasmtime/bin/wasmtime run --wasm max-wasm-stack=8388608 --wasi preview2 --dir /opt/experiment/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13-pydebug' _PYTHON_PROJECT_BASE=/opt/experiment/cpython/cross-build/wasm32-wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /opt/experiment/cpython/cross-build/wasm32-wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata_d_wasi_wasm32-wasi /opt/experiment/cpython/cross-build/build/python",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='/root/.wasmtime/bin/wasmtime run --wasm max-wasm-stack=8388608 --wasi preview2 --dir /opt/experiment/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13-pydebug' _PYTHON_PROJECT_BASE=/opt/experiment/cpython/cross-build/wasm32-wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /opt/experiment/cpython/cross-build/wasm32-wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata_d_wasi_wasm32-wasi /opt/experiment/cpython/cross-build/build/python -m test",
    ...
    'XCFOLDER': 'iOSTestbed.wasm32-wasi.$(shell date +%s)',
    'XCRESULT': 'iOSTestbed.wasm32-wasi.$(shell date +%s)/wasm32-wasi.xcresult',
    'XMLLIBSUBDIRS': 'xml xml/dom xml/etree xml/parsers xml/sax',
    'abs_builddir': '/opt/experiment/cpython/cross-build/wasm32-wasi',
    'abs_srcdir': '/opt/experiment/cpython/cross-build/wasm32-wasi/../..',
