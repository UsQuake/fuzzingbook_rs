...
module RbConfig
  RUBY_VERSION.start_with?("3.4.") or
    raise "ruby lib version (3.4.0) doesn't match executable version (#{RUBY_VERSION})"

  # Ruby installed directory.
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.4.0+0/wasm32-wasi")
  ...
  CONFIG["DLDSHARED"] = "$(LD) -shared -Xlinker --export-dynamic"
  CONFIG["DLDLIBS"] = "-lc"
  ...
  CONFIG["DLEXT"] = "so"
  CONFIG["LDSHAREDXX"] = ""
  CONFIG["LDSHARED"] = "$(LD) -shared -Xlinker --export-dynamic"
  ...
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  CONFIG["POSTLINK"] = "$(WASMOPT) --asyncify $(wasmoptflags) -o $@ $@; :"
  CONFIG["incflags"] = ""
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "clang version 18.1.2 (https://github.com/llvm/llvm-project 26a1d6601d727a96f4301d0d8647b5a42760ae0c)\nTarget: wasm32-unknown-wasi\nThread model: posix\nInstalledDir: /opt/experiment/wasi-sdk/bin"
  ...
  CONFIG["STRIP"] = "strip"
  CONFIG["RANLIB"] = "/opt/experiment/wasi-sdk/bin/llvm-ranlib"
  CONFIG["OBJDUMP"] = "objdump"
  CONFIG["OBJCOPY"] = "/opt/experiment/wasi-sdk/bin/llvm-objcopy"
  CONFIG["NM"] = "nm"
  CONFIG["LD"] = "/opt/experiment/wasi-sdk/bin/clang"
  CONFIG["CXX"] = "g++"
  CONFIG["AS"] = "as"
  CONFIG["AR"] = "/opt/experiment/wasi-sdk/bin/llvm-ar"
  CONFIG["CC"] = "$(CC_WRAPPER) /opt/experiment/wasi-sdk/bin/clang"
